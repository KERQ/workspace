...
| [SPEC-007H](../SPEC-007H-librechat-coding-agent-full-config.md) | homeserver-services + openclaw-control-plane + workspace | done | LibreChat: pełna konfiguracja `coding_agent` + skills + smoke/guardrails |
