...
- [x] [EPIC-009](specs/epics/EPIC-009-forgejo-bot.md): Forgejo bot read/comment/review — [runbook](docs/runbooks/t630-forgejo-openclaw-bot.md)
  - [x] [SPEC-009A](specs/SPEC-009A-forgejo-bot-user-token.md) — `openclaw-bot`, PAT, webhook secret
  ...
  - [x] [SPEC-009D](specs/SPEC-009D-forgejo-bot-smoke-runbook.md) — status check `OpenClaw Review`, smoke, contracts
  - Zakazy MVP: kod bota nie push/merge/deploy/contents; no `/openclaw fix`. PAT: `write:repository` tylko pod status check.
